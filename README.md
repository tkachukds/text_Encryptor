...
Если пользователь выбирает 2, программа просит ввести текст для расшифровки. Например, "ииаыюк, хкж йлзюи ыщяеуб кювйк, вжкжиуб ею эжгяюе ъукф ищйрамижыще". Затем пользователю предлагается ввести коды сдвига через запятую, аналогично выбору 1. 
...
Для запуска программы необходимо выполнить следующую команду: "запустить пайтон скрипт - main.py" или "запустить shifr.exe".
